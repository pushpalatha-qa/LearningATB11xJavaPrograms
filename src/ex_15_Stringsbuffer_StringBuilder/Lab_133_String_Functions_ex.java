...
public class Lab_133_String_Functions_ex {
...
//        System.out.println(name.charAt(10)); // StringIndexOutOfBoundsException
        ...
        // 3. contains()
        System.out.println(name.contains("om"));// returns boolean value

        // 4. equals()
        System.out.println(name.equals("Sonal"));// returns boolean value
